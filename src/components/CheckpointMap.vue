  ...
  <div class='checkpointmap'>
    <div  id="mapid" style="position:absolute;top:0px;left:0px;width: 100%;height: 100%;">
      <!--div class="control input-group">
          <input type="text" class="form-control input-sm" placeholder="Search">    <span class="input-group-btn">
      	  <button class="btn btn-default btn-sm" type="button">Go!</button>    </span>
      </div-->
    </div>
...
<style scoped>
  ...
  .leaflet-default-shadow-path {
      background-image: url(/static/marker-shadow.png);
  }
  #sidebar {
    position:absolute;
    top: 125px;
